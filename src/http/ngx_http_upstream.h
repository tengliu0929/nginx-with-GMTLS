...
typedef struct {
    ...
    //gmssl
	ngx_http_complex_value_t        *proxy_gmssl_sign_certificate;
	ngx_http_complex_value_t        *proxy_gmssl_sign_key;
	ngx_http_complex_value_t        *proxy_gmssl_enc_certificate;
	ngx_http_complex_value_t        *proxy_gmssl_enc_key;
#endif
